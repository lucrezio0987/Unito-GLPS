...
public class TestFoglioRiepilogativo5 {
    public static void main(String[] args) {
        try {
            ...
            Cuoco cuoco  = new Cuoco( "Mario Rossi");
            ...
            System.out.println("\nTEST SET COOCK");
            CatERing.getInstance().getFoglioRiepilogativoMng().assegnaCuoco(s.getCompiti().get(0).getId(), cuoco);
