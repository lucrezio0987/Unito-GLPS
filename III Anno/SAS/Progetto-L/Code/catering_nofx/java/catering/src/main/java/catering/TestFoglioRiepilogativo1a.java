...
public class TestFoglioRiepilogativo1a {
    public static void main(String[] args) {
        try {
            ...
            FoglioRiepilogativo foglio2 = new FoglioRiepilogativo(service2, user);
            ...
            CatERing.getInstance().getFoglioRiepilogativoMng().modificaFoglioRiepilogativo(foglio2);
            foglio = CatERing.getInstance().getFoglioRiepilogativoMng().getFoglioRiepilogativo();
            ...
            if (allSheets.isEmpty())
                ...
                for (FoglioRiepilogativo f : allSheets)
                    System.out.println(f.getServizio().getId());
