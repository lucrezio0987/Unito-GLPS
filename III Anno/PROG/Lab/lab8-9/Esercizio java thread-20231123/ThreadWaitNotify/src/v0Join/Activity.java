...
public class Activity implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("v0Join.Activity " + activityNumber + " waiting...");
        ...
        System.out.println("v0Join.Activity " + activityNumber + " running, counter:" + activityCounter);
        ...
        System.out.println("v0Join.Activity " + activityNumber + " ended.");
    }
}
