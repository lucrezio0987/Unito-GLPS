...
public class GeometriesExample {
    ...
    public static void main(String[] args) {
        ...
        Geometries<Triangle> geometries = new Geometries<>();
     ...
     */
    private static void interactiveMenu(Scanner input, Geometries<Triangle> geometries) {
     ...
     */
    private static void addPolygon(Scanner input, Geometries<Triangle> geometries, Triangle p) {
