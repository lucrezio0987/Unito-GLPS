...
void test_create_skiplist_empty()
{
    ...
    TEST_ASSERT_NULL(skiplist->next[0]);
}
...
void test_insert_skiplist()
{
    ...
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->item, test_string_item_2));
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->next[0]->item, test_string_item_0));
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->next[0]->next[0]->item, test_string_item_1));
}
...
void test_load_skiplist()
{
    ...
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->item, "amore"));
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->next[0]->item, "cuore"));
    TEST_ASSERT_EQUAL(0, CompareString(skiplist->next[0]->next[0]->next[0]->item, "sole"));
}
...
void test_search_skiplist()
{
    ...
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NULL(search_skiplist(skiplist, string));
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NULL(search_skiplist(skiplist, string));
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NULL(search_skiplist(skiplist, string));
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NOT_NULL(search_skiplist(skiplist, string));
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NOT_NULL(search_skiplist(skiplist, string));
    fscanf(f_corectme, "%s", string);
    TEST_ASSERT_NOT_NULL(search_skiplist(skiplist, string));
